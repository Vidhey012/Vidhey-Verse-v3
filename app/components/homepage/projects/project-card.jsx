...
function ProjectCard({ project }) {
  return (
    <PixelCard variant="blue" className="from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37] w-full">
      ...
      <div className="px-4 lg:px-8 py-3 lg:py-5 relative">
        ...
        <div className="flex items-center gap-2 justify-center">
          <p className="head text-[#16f2b3] text-base lg:text-xl">
            {project.title}
          </p>
