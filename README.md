...
```
git clone https://github.com/<YOUR GITHUB USERNAME>/Vidhey-Verse-v2.git
...
### Then, Customize data in the `utils/data` [folder](https://github.com/Vidhey012/Vidhey-Verse-v2/tree/main/utils/data).
